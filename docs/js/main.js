...
(function() {
  var ingredients, ingredientsInPot, outputBox, outputSlot, potSlots, qualitySlot, reset, typeSlot;
  ...
  $(document).ready(function() {
    var ambrosia, apricorn, attributes, balm, blue, bluk, bug, electric, fighting, fire, flying, fossil, grass, gray, ground, honey, icy, normal, poison, psychic, rainbow, recipes, red, rock, root, shell, tiny, types, water, yellow;
    ...
    return $("#start").mousedown(function(e) {
      var attribute, check, expeditions, i, image, index, ingredient, j, k, l, len, len1, n, rating, recipe, total;
      e.preventDefault();
...
// Checks to see if the ingredients in the pot match any recipes
        for (index = k = 0, len1 = recipes.length; k < len1; index = ++k) {
          recipe = recipes[index];
          check = true;
          for (attribute = l = 0; l <= 10; attribute = ++l) {
  ...
  $(document).ready(function() {
    return $("span").mousedown(function(e) {
      $(".modal").removeClass("show");
      return $(".modal-content").removeClass("show");
    });
  });
